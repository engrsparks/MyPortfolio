...
class _CheckOutScreenState extends State<CheckOutScreen> {
  ...
  final TextEditingController _interestCost = TextEditingController();
  final TextEditingController _gradient = TextEditingController();
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            try {
                                                                              if (_checkOutProvider.checkOutProducts.isNotEmpty && _enterAmount.isNotEmpty && _deliveryCharge.text.isEmpty && _checkOutProvider.checkOutChange >= 0) {
                                                                                _salesProvider.addSales(_salesInvoiceNumber, _customerName.text, _checkOutProvider.totalAmount, 0.0, 0.0, _checkOutProvider.totalDiscount, (_checkOutProvider.totalCost), _checkOutProvider.checkOutProducts.values.toList(), _checkOutProvider.numberOfProductsSold, 0.0, 0.0, 0.0, '');
                                                                                _salesReportProvider.addSalesReport(_salesInvoiceNumber, _customerName.text, _checkOutProvider.totalAmount, 0.0, 0.0, _checkOutProvider.totalDiscount, (_checkOutProvider.totalCost), _checkOutProvider.checkOutProducts.values.toList(), _checkOutProvider.numberOfProductsSold);
                                                                                ...
                                                                                Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                                                                                  return ReceiptPrinter(
                                                                                    ...
                                                                                    enterpriseNameForPrint: 'RRRMC AGRIVET SUPPLY',
                                                                                ...
                                                                                _salesProvider.addSales(_salesInvoiceNumber, _customerName.text, _checkOutProvider.totalAmount, 0.0, 0.0, _checkOutProvider.totalDiscount, (_checkOutProvider.totalCost), _checkOutProvider.checkOutProducts.values.toList(), _checkOutProvider.numberOfProductsSold, 0.0, 0.0, (_checkOutProvider.numberOfProductsSold * double.parse(_deliveryCharge.text)), '');
                                                                                _salesReportProvider.addSalesReport(_salesInvoiceNumber, _customerName.text, _checkOutProvider.totalAmount, 0.0, 0.0, _checkOutProvider.totalDiscount, (_checkOutProvider.totalCost), _checkOutProvider.checkOutProducts.values.toList(), _checkOutProvider.numberOfProductsSold);
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            try {
                                                                              if (_checkOutProvider.checkOutProducts.isNotEmpty && _enterAmount.isNotEmpty && _deliveryCharge.text.isEmpty && _checkOutProvider.checkOutChange >= 0) {
                                                                                _salesProvider.addSales(_salesInvoiceNumber, _customerName.text, 0.0, _checkOutProvider.totalAmount, 0.0, _checkOutProvider.totalDiscount, (_checkOutProvider.totalCost), _checkOutProvider.checkOutProducts.values.toList(), _checkOutProvider.numberOfProductsSold, 0.0, 0.0, 0.0, '');
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    try {
                                                                      if (_checkOutProvider.checkOutProducts.isNotEmpty &&
                                                                        ...
                                                                        Provider.of<AccountsReceivableModelProvider>(context, listen: false).addAr(
                                                                            _salesInvoiceNumber,
                                                                            _customerName
                                                                                .text,
                                                                            (_checkOutProvider.totalAmount +
                                                                        ...
                                                                        //   //   double.parse(_enterAmount),
                                                                        //   // );
                                                                        //   // Provider.of<CashFlowReportsModelProvider>(context, listen: false).addCashFlowReports(_customerName.text, _salesInvoiceNumber, double.parse(_enterAmount), double.parse(_enterAmount), _checkOutProvider.numberOfProductsSold);
                                                                        // }
                                                                        //
                                                                        _salesProvider.addSales(
                                                                            _salesInvoiceNumber,
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    try {
                                                                      if (_checkOutProvider.checkOutProducts.isNotEmpty &&
                                                                        ...
                                                                        //   0.0,
                                                                        //   _checkOutProvider.checkOutChange,
                                                                        //   (_checkOutProvider.totalAmount + _checkOutProvider.checkOutChange),
                                                                        //   _salesInvoiceNumber,
                                                                        //   double.parse(_interestCost.text),
                                                                        //   double.parse(_gradient.text),
                                                                        //   _checkOutProvider.numberOfProductsSold,
                                                                        ...
                                                                        //   //   double.parse(_enterAmount),
                                                                        //   // );
                                                                        //   // Provider.of<CashFlowReportsModelProvider>(context, listen: false).addCashFlowReports(_customerName.text, _salesInvoiceNumber, 0.0, double.parse(_enterAmount), _checkOutProvider.numberOfProductsSold);
                                                                        // }
                                                                        //
                                                                        _salesProvider.addSales(
                                                                            _salesInvoiceNumber,
