...
Future main() async {
  ...
  Hive.registerAdapter(AccountsReceivableModelAdapter());
  await Hive.openBox<AccountsReceivableModel>('accounts_receivable_box');
    ...
    return Sizer(builder: (context, orientation, deviceType) {
      return MultiProvider(
          providers: [
            ...
            ChangeNotifierProvider(
                create: (context) => AccountsReceivableModelProvider()),
            ChangeNotifierProvider(
                create: (context) => ArCollectionsModelProvider()),
            ChangeNotifierProvider(
