              ...
              onPressed: () async {
                try {
                  ...
                  page.graphics.drawString(
                    'Total Cheque: ' +
                        NumberFormat()
                            .format(_dailySalesProvider.dailySalesCheque),
                    PdfStandardFont(PdfFontFamily.helvetica, 13),
                    brush: PdfBrushes.black,
                  ...
                  page.graphics.drawString(
                    'Total AR: ' +
                        NumberFormat().format(_dailySalesProvider.dailySalesAr),
                    PdfStandardFont(PdfFontFamily.helvetica, 13),
                    brush: PdfBrushes.black,
                    ...
                    'Total Sales: ' +
                        NumberFormat().format(
                            _dailySalesProvider.dailySalesCash -
                                _dailySalesProvider.dailySalesAr),
                    PdfStandardFont(PdfFontFamily.helvetica, 13),
                    brush: PdfBrushes.black,
                  ...
                  page.graphics.drawString(
                    ...
                    PdfStandardFont(PdfFontFamily.helvetica, 13),
                    brush: PdfBrushes.black,
                    bounds: Rect.fromLTWH(10, 205, 70.w, 8.h),
                  );
                  ...
                  i++) {
                    ...
                    row.cells[3].value = NumberFormat()
                        .format(_dailySalesProvider.listOfDailySales[i].cheque);
                    row.cells[3].stringFormat = PdfStringFormat(
                        lineAlignment: PdfVerticalAlignment.middle,
                        alignment: PdfTextAlignment.center);

                    row.cells[4].value = NumberFormat()
                        .format((_dailySalesProvider.listOfDailySales[i].ar));
                    ...
                    row.cells[5].value = NumberFormat().format(
                        (_dailySalesProvider.listOfDailySales[i].cash +
                            _dailySalesProvider.listOfDailySales[i].cheque -
                            _dailySalesProvider.listOfDailySales[i].ar));
                ...
                Column(
                  ...
                  children: [
                    Text(
                      'TOTAL AR: ₱ ' +
                          NumberFormat()
                              .format(_dailySalesProvider.dailySalesAr),
                      style: TextStyle(
                          fontSize: 8.sp,
                          fontFamily: 'Quicksand',
                          fontWeight: FontWeight.w600),
                ...
                Column(
                  ...
                  children: [
                    Text(
                      'TOTAL SALES: ₱ ' +
                          NumberFormat().format(
                              (_dailySalesProvider.dailySalesAr * -1) +
                                  _dailySalesProvider.dailySalesCheque +
                                  _dailySalesProvider.dailySalesCash),
                      style: TextStyle(
                          fontSize: 8.sp,
                          fontFamily: 'Quicksand',
