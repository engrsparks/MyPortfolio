              ...
              onPressed: () async {
                try {
                  ...
                  page.graphics.drawString(
                    'Total Cheque: ' +
                        NumberFormat()
                            .format(_monthlySalesProvider.monthlySalesCheque),
                    PdfStandardFont(PdfFontFamily.helvetica, 13),
                    brush: PdfBrushes.black,
                  ...
                  page.graphics.drawString(
                    'Total AR: ' +
                        NumberFormat().format(_monthlySalesProvider.monthlySalesAr),
                    PdfStandardFont(PdfFontFamily.helvetica, 13),
                    brush: PdfBrushes.black,
                    ...
                    'Total Sales: ' +
                        NumberFormat().format(
                            _monthlySalesProvider.monthlySalesCash -
                                _monthlySalesProvider.monthlySalesAr),
                    PdfStandardFont(PdfFontFamily.helvetica, 13),
                    brush: PdfBrushes.black,
                  ...
                  i++) {
                    ...
                    row.cells[3].value = NumberFormat()
                        .format(_monthlySalesProvider.listOfMonthlySales[i].cheque);
                    row.cells[3].stringFormat = PdfStringFormat(
                        lineAlignment: PdfVerticalAlignment.middle,
                        alignment: PdfTextAlignment.center);

                    row.cells[4].value = NumberFormat()
                        .format((_monthlySalesProvider.listOfMonthlySales[i].ar));
                    ...
                    row.cells[5].value = NumberFormat().format(
                        (_monthlySalesProvider.listOfMonthlySales[i].cash +
                            _monthlySalesProvider.listOfMonthlySales[i].cheque -
                            _monthlySalesProvider.listOfMonthlySales[i].ar));
